...
> [!NOTE]
> Ported from [Conductor Extension for Gemini CLI](https://github.com/gemini-cli-extensions/conductor).
...
- [GitHub issues](https://github.com/cloudaura-io/conductor-claude-code/issues): Report bugs or request features
